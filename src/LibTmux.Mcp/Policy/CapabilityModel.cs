...
internal sealed class CapabilityRegistry
{
    ...
    private static ImmutableArray<ToolDefinition> BuildDefinitions()
    {
        ...
        [
            ...
            Inspect("wait_for_text", "Wait for text", PaneOutput, nameof(CapabilityTools.WaitForTextAsync), S(("paneId", InputSink.TmuxLookup), ("patterns", InputSink.Regex), ("stopPatterns", InputSink.Regex), ("timeoutSeconds", InputSink.None), ("ignoreCase", InputSink.None)), terminal: true, selfBounded: true),
            ...
            ManageTool("set_history_limit", "Set history limit", Manage, nameof(CapabilityTools.SetHistoryLimitAsync), S(("lines", InputSink.TmuxState), ("windowId", InputSink.TmuxLookup)), stateOnly: true),
            ...
            Execute("run_shell_command", "Run shell command", Command, ProcessReach.PaneCommand, nameof(CapabilityTools.RunShellCommandAsync), SM(M("command", InputSink.PaneInput, InputSink.ShellCommand), M("paneId", InputSink.TmuxLookup), M("timeoutSeconds", InputSink.None), M("maxLines", InputSink.None), M("suppressHistory", InputSink.None)), terminal: true),
            Execute("send_keys", "Send keys", Input, ProcessReach.PaneInput, nameof(CapabilityTools.SendKeysAsync), S(("keys", InputSink.PaneInput), ("paneId", InputSink.TmuxLookup), ("enter", InputSink.PaneInput), ("literal", InputSink.None), ("suppressHistory", InputSink.None))),
